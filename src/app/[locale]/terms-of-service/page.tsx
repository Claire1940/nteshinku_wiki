...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - NTE Shinku Wiki",
    description: "Read the Terms of Service for NTE Shinku Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - NTE Shinku Wiki",
      description: "Terms and conditions for using NTE Shinku Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using NTE Shinku Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using NTE Shinku Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and NTE Shinku Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              NTE Shinku Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "Neverness to Everness". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Shinku build and Arc guides</li>
              <li>Banner schedule and pull-value analysis</li>
              <li>Team comp and synergy recommendations</li>
              <li>Outfit and cosmetic unlock guides</li>
              <li>Story, bond, and event walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> NTE Shinku Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or the official developers of Neverness to Everness. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by NTE Shinku Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or the developers of Neverness to Everness. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, NTE SHINKU WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and NTE Shinku Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@nteshinku.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@nteshinku.wiki</a>
            </p>
            <p>
