...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.nteshinku.wiki'
  const path = '/about'
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Neverness to Everness players with accurate, up-to-date information
              and powerful tools</strong> that help them succeed in the game. We strive to:
            </p>
            <ul>
              <li><strong>Provide reliable information:</strong> Keep our content updated with the latest patch notes, balance changes, and banner schedules</li>
              <li><strong>Build useful tools:</strong> Develop build, Arc, and team guides that help players make informed pull and build decisions</li>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Comprehensive build, Arc, and module recommendations for Shinku.
                Master her S-Class COSMOS kit and combat role!
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Banner Information</h3>
              <p className="text-slate-300">
                Shinku's banner dates, pull rates, and pull-value analysis.
                Decide when and whether to pull with confidence.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">👥</div>
              <h3 className="text-xl font-semibold text-white mb-2">Team Comps</h3>
              <p className="text-slate-300">
                Team synergies and recommended comps that bring out Shinku's full potential.
                Build the best squad for every mode.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">👗</div>
              <h3 className="text-xl font-semibold text-white mb-2">Outfits &amp; Cosmetics</h3>
              <p className="text-slate-300">
                Shinku's outfits and cosmetics, including how to unlock each one.
                Complete your collection with our guides.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">📖</div>
              <h3 className="text-xl font-semibold text-white mb-2">Story &amp; Profile</h3>
              <p className="text-slate-300">
                Shinku's background, bond, City Hangouts, and Home Time content.
                Dive into her lore and story unlocks.
              </p>
            </div>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              <strong>Want to contribute?</strong> Whether you've found a new build strategy, discovered a strong team combo,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Neverness to Everness mechanics and strategies</li>
            ...
            <p className="text-slate-400 italic text-sm">
              Project Codename: "Hethereau" – Hunting anomalies together.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@nteshinku.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@nteshinku.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@nteshinku.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@nteshinku.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@nteshinku.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@nteshinku.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@nteshinku.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@nteshinku.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Neverness to Everness news.
